...
class Settings(BaseSettings):
    ...
    inference_torch_cpu_threads: int = Field(default=4)
    inference_opencv_cpu_threads: int = Field(default=6)
    ...
    paddleocr_enable_mkldnn: bool = Field(default=False)
    paddleocr_cpu_threads: int = Field(default=4)
    ...
    plate_video_worker_prestart: bool = Field(default=False)
